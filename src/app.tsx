...
import { PlannerView } from "./ui/views/PlannerView.tsx";

type TabKey = "results" | "standings" | "bracket" | "schedule" | "players" | "stats" | "planner" | "setup";
...
export function App() {
  ...
  return (
    <div class="app">
      ...
      {tab === "planner" && <PlannerView events={events} />}
      {tab === "setup" && (
