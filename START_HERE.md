...
5. Wait for it to confirm the baseline (~115 tests passing), then ask for new work.
...
> Then run `npm install` and `npm test` to confirm the baseline (about 115 tests should pass).
